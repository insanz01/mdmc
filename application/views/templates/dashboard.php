        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-info justify-content-center" href="">
                <div class="sidebar-brand-icon">
                    <img src="<?= base_url(); ?>assets/img/mdmc.jpg" width="74px" height="60p">
                </div>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link pt-0" href="<?= base_url('lokasi'); ?>">
                    <i class="fas fa-fw fa-users"></i>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aplikasi Manajemen Barang 2020 &bull; by <b>MDMC DIY</b></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
