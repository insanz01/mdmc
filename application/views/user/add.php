                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                      <div class="custom-control custom-radio">
                          <input <?= set_radio('role', 'kepala'); ?> value="kepala" type="radio" id="kepala" name="role" class="custom-control-input">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 'assessment'); ?> value="assessment" type="radio" id="assessment" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="gudang">Assessment</label>
                        </div>
